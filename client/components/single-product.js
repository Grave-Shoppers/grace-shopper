...
render () {
  ...
  const selectedProduct = this.props.products.products.filter(product => product.id === productId)

  console.log('productId', productId)
  console.log('selectedProduct', selectedProduct)
  console.log('selectedproduct0', selectedProduct[0])

if(!selectedProduct[0]) { return <h1>loading...</h1> }
